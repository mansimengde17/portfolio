...
const AWARDS = [
  {
    ...
    subtitle: "AWS All Builders Welcome Grant — AWS re:Invent 2025",
    ...
    photo: "/manus-storage/aws-reinvent-group_4cba1dab.jpeg",
  ...
  },
  {
    ...
    subtitle: "Excellence Award for Outstanding Leadership",
    issuer: "ITSC",
    date: "November 2019",
    location: "India",
    description: "Awarded for outstanding leadership, dedication, and impact as ITSC Committee Chairperson. Recognized for exemplary contributions to the institution's technical and student community.",
    photo: "/manus-storage/excellence-award_2c831b9c.webp",
    photoAlt: "Mansi Mengde receiving the ITSC Excellence Award",
    photoCaption: "ITSC Excellence Award — November 2019",
    color: "#8A9BB0",
    tag: "Leadership",
  },
];
